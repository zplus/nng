...
NNG_DECL int nng_dialer_get_sockaddr(
    nng_dialer, const char *, nng_sockaddr *);
...
NNG_DECL int nng_listener_get_ms(
    nng_listener, const char *, nng_duration *);
NNG_DECL int nng_listener_get_size(nng_listener, const char *, size_t *);
NNG_DECL int nng_listener_get_sockaddr(
    nng_listener, const char *, nng_sockaddr *);
NNG_DECL int nng_listener_get_uint64(
    nng_listener, const char *, uint64_t *);
...
NNG_DECL int nng_pipe_get_sockaddr(nng_pipe, const char *, nng_sockaddr *);
